...
import { FaExternalLinkAlt, FaServer, FaNetworkWired, FaDocker, FaShieldAlt, FaScroll } from 'react-icons/fa';
    ...
    return (
        <main className="min-h-screen bg-black text-green-500 font-mono selection:bg-green-900 selection:text-white relative pt-24 pb-12">
            ...
            <div className="relative z-10 container mx-auto px-4 max-w-4xl">
                ...
                >
                    <SiApachekafka className="text-6xl md:text-8xl text-white mx-auto mb-6" />
                ...
                <div className="space-y-12">
                    ...
                    {/* Why Kafka vs API */}
                    <Section title="3. Why Kafka? (vs REST API)" icon={<FaServer />}>
...
Revelation Service`}
                    ...
                    {/* Security */}
                    <Section title="6. Security Considerations" icon={<FaShieldAlt />}>
                        <ul className="list-disc list-inside space-y-2 text-gray-400 ml-4">
                            <li><strong className="text-red-400">Do not expose Kafka ports:</strong> Only internal services access port 9092.</li>
                            <li><strong className="text-red-400">Internal Network:</strong> All containers share a private Docker network.</li>
                            <li><strong className="text-red-400">No Sensitive Data:</strong> We only stream soul metadata, not credit cards.</li>
                        </ul>
                    </Section>
